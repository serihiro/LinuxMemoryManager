...
static void split_blocks(block_meta_data_t *block_meta_data) {
...
int main(int argc, char **argv) {
  ...
  block_meta_data_t *first_block_meta_data = (block_meta_data_t *)vm_page;

  first_block_meta_data->is_free = MM_TRUE;
  first_block_meta_data->block_size =
